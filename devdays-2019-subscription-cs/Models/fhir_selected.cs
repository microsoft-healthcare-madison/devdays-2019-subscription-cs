// <auto-generated>
/** GENERATED FILE **/
/** Generated by: gino.canessa at 5/1/2020 11:12:49 AM **/
/** Restricted to types: Subscription|SubscriptionTopic|SubscriptionStatus|Bundle|Patient|Encounter|Practitioner|Observation|CapabilityStatement|OperationOutcome|Group|Basic **/
using System;
...
namespace fhir
{
	...
	///<summary>Code Values for the CanonicalResource.status field</summary>
	...
	///<summary>Code Values for the Subscription.content field</summary>
	...
	///<summary>Code Values for the Subscription.contentType field</summary>
	...
	///<summary>Code Values for the SubscriptionFilterBy.searchModifier field</summary>
	...
	///<summary>Code Values for the SubscriptionStatus.notificationType field</summary>
	...
	///<summary>Code Values for the SubscriptionStatus.status field</summary>
	...
	///<summary>Code Values for the SubscriptionTopicCanFilterBy.searchModifier field</summary>
	...
	public abstract class SubjectType
	{
		...
		///<summary>A clinical or business level record of information being transmitted or shared; e.g. an alert that was sent to a responsible provider, a public health agency communication to a provider/reporter in response to a case report for a reportable condition.</summary>
		...
		///<summary>A record of a device being used by a patient where the record is the result of a report from the patient or a clinician.</summary>
		...
		///<summary>The EvidenceVariable resource describes an element that knowledge (Evidence) is about.</summary>
		...
		///<summary>A food or fluid product that is consumed by patients.</summary>
		...
		///<summary>The regulatory authorization of a medicinal product, device or process.</summary>
		...
		///<summary>The SubscriptionStatus resource describes the state of a Subscription during notifications.</summary>
		public static readonly Coding SubscriptionState = new Coding
		{
	...
	///<summary>Core-defined FHIR channel types allowed for use in Subscriptions.</summary>
	public abstract class SubscriptionChannelType
	{
		///<summary>The channel is executed by making a POST to the URI with the selected payload and MIME type.</summary>
	...
	public abstract class SubscriptionChannelTypeValues : SubscriptionChannelType { }
	...
	///</summary>
	///<source-file>c:/git/fhir\publish\canonicalresource.profile.canonical.json</source-file>
	public class CanonicalResource : DomainResource
	{
		///<summary>Resource Type Name (for serialization)</summary>
		[JsonProperty(PropertyName = "resourceType")]
		public string ResourceType => "CanonicalResource";
		...
		///<summary>Allows filtering of {{title}}s that are appropriate for use versus not.</summary>
		[JsonProperty(PropertyName = "status")]
		public string Status { get; set; }
		///<summary>May contain extended information for property: 'Status'</summary>
		[JsonProperty(PropertyName = "_status")]
	...
	public class CapabilityStatement : CanonicalResource
	{
		///<summary>Resource Type Name (for serialization)</summary>
		[JsonProperty(PropertyName = "resourceType")]
	...
	///</summary>
	///<source-file>c:/git/fhir\publish\codeablereference.profile.canonical.json</source-file>
	public class CodeableReference : DataType
	{
		///<summary>A reference to a concept - e.g. the information is identified by it's general classto the degree of precision found in the terminology.</summary>
		...
		///<summary>A reference to a resource the provides exact details about the information being referenced.</summary>
	...
	public class Encounter : DomainResource
	{
		...
		///<summary>Reason the encounter takes place, expressed as a code or a reference to another resource. For admissions, this can be used for a coded admission diagnosis.</summary>
	...
	public class Extension : DataType
	{
		...
		///<summary>Value of extension - must be one of a constrained set of the data types (see [Extensibility](extensibility.html) for a list).</summary>
		[JsonProperty(PropertyName = "valueInteger64")]
		public string ValueInteger64 { get; set; }
		///<summary>May contain extended information for property: 'ValueInteger64'</summary>
		[JsonProperty(PropertyName = "_valueInteger64")]
	...
	public class Subscription : DomainResource
	{
		...
		///<summary>May contain extended information for property: 'ChannelType'</summary>
		[JsonProperty(PropertyName = "_channelType")]
		...
		[JsonProperty(PropertyName = "_status")]
		public Element _Status { get; set; }
		///<summary>If present, the maximum amount of time a server will allow before failing a notification attempt.</summary>
		[JsonProperty(PropertyName = "timeout")]
		public uint? Timeout { get; set; }
		///<summary>May contain extended information for property: 'Timeout'</summary>
		[JsonProperty(PropertyName = "_timeout")]
	...
	public class SubscriptionFilterBy : Element
	{
		...
		[JsonProperty(PropertyName = "searchModifier")]
		public string SearchModifier { get; set; }
		///<summary>May contain extended information for property: 'SearchModifier'</summary>
		[JsonProperty(PropertyName = "_searchModifier")]
		public Element _SearchModifier { get; set; }
		///<summary>The filter label (=key) as defined in the `SubscriptionTopic.canfilterBy.searchParamName`  element.</summary>
		[JsonProperty(PropertyName = "searchParamName")]
		public string SearchParamName { get; set; }
		///<summary>May contain extended information for property: 'SearchParamName'</summary>
		[JsonProperty(PropertyName = "_searchParamName")]
	...
	///</summary>
	///<source-file>c:/git/fhir\publish\subscriptionstatus.profile.canonical.json</source-file>
	public class SubscriptionStatus : DomainResource
	{
		///<summary>Resource Type Name (for serialization)</summary>
		[JsonProperty(PropertyName = "resourceType")]
		public string ResourceType => "SubscriptionStatus";
		///<summary>The total number of actual events represented within this notification.  For handshake and heartbeat notifications, this will be zero or not present.  For event-notifications, this number may be one or more, depending on server batching.</summary>
		[JsonProperty(PropertyName = "eventsInNotification")]
		public int? EventsInNotification { get; set; }
		///<summary>May contain extended information for property: 'EventsInNotification'</summary>
		[JsonProperty(PropertyName = "_eventsInNotification")]
		public Element _EventsInNotification { get; set; }
		///<summary>The total number of actual events which have been generated since the Subscription was created (inclusive of this notification) - regardless of how many have been successfully communicated.  This number is NOT incremented for handshake and heartbeat notifications.</summary>
		[JsonProperty(PropertyName = "eventsSinceSubscriptionStart")]
		public string EventsSinceSubscriptionStart { get; set; }
		///<summary>May contain extended information for property: 'EventsSinceSubscriptionStart'</summary>
		[JsonProperty(PropertyName = "_eventsSinceSubscriptionStart")]
		public Element _EventsSinceSubscriptionStart { get; set; }
		///<summary>The type of event being conveyed with this notificaiton.</summary>
		[JsonProperty(PropertyName = "notificationType")]
		public string NotificationType { get; set; }
		///<summary>May contain extended information for property: 'NotificationType'</summary>
		[JsonProperty(PropertyName = "_notificationType")]
		...
		[JsonProperty(PropertyName = "_status")]
		public Element _Status { get; set; }
		///<summary>The reference to the Subscription which generated this notification.</summary>
		[JsonProperty(PropertyName = "subscription")]
		public Reference Subscription { get; set; }
		///<summary>May contain extended information for property: 'Subscription'</summary>
		[JsonProperty(PropertyName = "_subscription")]
		public Element _Subscription { get; set; }
		///<summary>The reference to the SubscriptionTopic for the Subscription which generated this notification.</summary>
		[JsonProperty(PropertyName = "topic")]
		public Reference Topic { get; set; }
		///<summary>May contain extended information for property: 'Topic'</summary>
		[JsonProperty(PropertyName = "_topic")]
	...
	public class SubscriptionTopicResourceTrigger : Element
	{
		...
		[JsonProperty(PropertyName = "_description")]
		public Element _Description { get; set; }
		///<summary>The FHIRPath based rules that the server should use to determine when to trigger a notification for this topic.  If there are multiple, FHIRPath filters are joined with AND.</summary>
